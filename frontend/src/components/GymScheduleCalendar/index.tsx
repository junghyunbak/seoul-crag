    ...
    <Box>
      ...
      <Grid container columns={7} spacing={0.5}>
        ...
        {days.map((day) => {
          ...
          return (
            <Grid item xs={1} key={iso} sx={{ border: '1px solid #ccc', height: 100, position: 'relative', p: 0.5 }}>
              <Typography align="center" variant="body2" sx={{ color: isHoliday(iso, day) ? 'error.main' : undefined }}>
                {format(day, 'd')}
              </Typography>

              <Stack spacing={0.5} mt={0.5} maxHeight={60} overflow="auto">
