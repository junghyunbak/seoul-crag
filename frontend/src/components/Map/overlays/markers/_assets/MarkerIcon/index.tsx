...
interface ActiveMarkerIconProps extends MarkerIconProps {
  bgColor?: string;
  bottomMountainColor?: string;
}

function ActiveMarkerIcon({ width, bgColor = '#6D8C57', bottomMountainColor = '#93A667' }: ActiveMarkerIconProps) {
  return (
